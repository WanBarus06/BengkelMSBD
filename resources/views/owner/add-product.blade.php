...
<body>
    ...
    <div class="container mt-5">
        <h3 class="text-center mb-4">Tambahkan Produk</h3>
        <form method="POST" action="{{ route('product.store')}}">
            ...
            <div class="col-md-6">
                ...
                <input type="number" id="price" name="product_sell_price" class="form-control" required>
            </div>
            </div>
            <div class="row g-3 mt-3">
                <div class="col-md-6">
                    <label for="size" class="form-label">Stok Warning</label>
                    <input type="number" name="warning_stock" class="form-select" required >
                </div>
            ...
            <div class="row g-3 mt-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="description" name="product_description" class="form-control" required>
                </div>
