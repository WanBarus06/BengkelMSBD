...
return new class extends Migration
{
    ...
    {
        DB::statement('
        CREATE PROCEDURE CompleteOrder(IN cartId INT, IN StaffId INT)
BEGIN
    -- Deklarasi variabel
    ...
    ELSE
        ...
        ELSE
            ...
            INSERT INTO sales_records (staff_id, customer_id, is_fully_paid, created_at, updated_at)
            VALUES (StaffId ,customerId, TRUE, NOW(), NOW());
