...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        BEGIN
            ...
            INSERT INTO sales_records (staff_id, offline_customer_name, offline_customer_phone_number, offline_customer_address, is_fully_paid, created_at, updated_at)
            VALUES (StaffId, offlineCustomerName, offlineCustomerPhoneNumber, offlineCustomerAddress, isFullyPaid, NOW(), NOW());
    ...
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS CompleteOfflineOrder');
    }
};
