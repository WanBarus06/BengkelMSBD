...
return new class extends Migration
{
    ...
    public function up(): void
    {
              ...
              DB::statement('
              CREATE PROCEDURE ConfirmPurchaseInvoice(IN cartId INT, IN supplierId INT , IN StaffId INT)
              BEGIN
                  ...
                  INSERT INTO purchase_invoices (staff_id, supplier_id, created_at, updated_at)
                  VALUES (StaffId, supplierId, NOW(), NOW());
    ...
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS ConfirmPurchaseInvoice');
    }
};
